 ...
 *
 *  runWithinPluginEditor ([&] (FieldEngineSynthProcessor& plugin) {
 ...
 *
 */
[[maybe_unused]] static void runWithinPluginEditor (const std::function<void (FieldEngineSynthProcessor& plugin)>& testCode)
{
    FieldEngineSynthProcessor plugin;
